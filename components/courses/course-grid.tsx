...
import { Clock, LayoutGrid, Star, Users, Tag, Sparkles, ChevronLeft, ChevronRight } from "lucide-react"
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      try {
        ...
        filterParams.page = String(currentPage)
  ...
  return (
    <section>
      <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 flex items-center gap-2">
        ...
        <span className="text-primary">{String(pagination.total_courses || courses.length).padStart(2, "0")}</span>{" "}
          ...
          {pagination.total_pages > 1 && (
            <div className="flex items-center justify-center gap-2 pt-2">
              <button
                ...
                className="inline-flex items-center gap-1 rounded-md border border-border px-3 py-1.5 text-xs sm:text-sm text-muted-foreground hover:bg-muted disabled:opacity-50"
              >
